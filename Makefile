...
results: sim synth
	python3 scripts/save_result_snapshot.py --version v22 --mac-variant row4 --datapath "4-lane row MAC" --sim-summary build/sim/row4/sim_summary.json --synth-summary build/synth/row4/synth_summary.json

results-serial: sim-serial synth-serial
	python3 scripts/save_result_snapshot.py --version v22 --mac-variant serial --datapath "serial MAC baseline" --sim-summary build/sim/serial/sim_summary.json --synth-summary build/synth/serial/synth_summary.json

results-full16: sim-full16 synth-full16
	python3 scripts/save_result_snapshot.py --version v22 --mac-variant full16 --datapath "16-lane full parallel MAC" --sim-summary build/sim/full16/sim_summary.json --synth-summary build/synth/full16/synth_summary.json
