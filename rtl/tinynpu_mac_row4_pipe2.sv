  ...
  always_ff @(posedge clk or negedge rst_n) begin
    if (!rst_n) begin
      ...
      case (state_q)
        ...
        S_MUL_ROW: begin
          prod0_q <= product_at(sel_a_q, sel_b0_q);
          prod1_q <= product_at(sel_a_q, sel_b1_q);
          prod2_q <= product_at(sel_a_q, sel_b2_q);
          prod3_q <= product_at(sel_a_q, sel_b3_q);
          state_q <= S_ACC_ROW;
        end
