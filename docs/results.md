...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- |
| v18 | row4 | 4-lane row MAC | 26 | 14514 | 1.00x | 1.00x | scenario summary generated | Default datapath; generic gates only |
| v18 | serial | serial MAC baseline | 66 | 10347 | 2.54x | 0.71x | scenario summary generated | Lower cell count, higher latency; generic gates only |
| v18 | full16 | 16-lane full parallel MAC | 8 | 34149 | 0.31x | 2.35x | scenario summary generated | Lowest latency, highest generic cell count |
...
| --- | --- | --- | ---: | --- |
| v18 | `tinynpu_apb_wrapper` | row4 | 14560 | Generic Yosys only; APB wrapper around default core |
| v18 | `tinynpu_dma_descriptor_wrapper` | row4 | 15238 | Generic Yosys only; descriptor registers plus APB-wrapped core, no DMA data mover |
