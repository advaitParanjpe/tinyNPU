...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- | --- |
| v11 | row4 | 4-lane row MAC | 26 | 14321 | 1.00x | 1.00x | scenario summary generated | Default datapath; generic gates only |
| v11 | serial | serial MAC baseline | 66 | 10154 | 2.54x | 0.71x | scenario summary generated | Lower cell count, higher latency; generic gates only |
| v11 | full16 | 16-lane full parallel MAC | 8 | 33956 | 0.31x | 2.37x | scenario summary generated | Lowest latency, highest generic cell count |
